...
**Files:**
- Read: `docs/changes/c-50-ownership-gate/10_design.md`
- Read: `docs/changes/c-50-ownership-gate/20_plan.md`
...
```bash
git add docs/changes/c-50-ownership-gate/10_design.md \
