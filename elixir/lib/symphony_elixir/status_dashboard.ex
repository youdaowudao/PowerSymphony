defmodule SymphonyElixir.StatusDashboard do
  ...
  @doc false
  @spec format_running_summary_for_test(map()) :: String.t()
  def format_running_summary_for_test(running_entry),
    do: format_running_summary(running_entry, @running_event_default_width)

  @doc false
  @spec format_running_summary_for_test(map(), integer() | nil) :: String.t()
  def format_running_summary_for_test(running_entry, nil),
    do: format_running_summary_for_test(running_entry)

  @doc false
  @spec format_running_summary_for_test(map(), integer() | nil) :: String.t()
  def format_running_summary_for_test(running_entry, terminal_columns),
