defmodule SymphonyElixirWeb.Router do
  ...
  scope "/", SymphonyElixirWeb do
    ...
    get("/api/v1/projects/:project_id/runs/:issue_identifier/context", ObservabilityApiController, :project_run_context)
    ...
    match(:*, "/api/v1/projects/:project_id/runs/:issue_identifier/context", ObservabilityApiController, :method_not_allowed)
    ...
    get("/api/v1/runs/:issue_identifier/context", ObservabilityApiController, :run_context)
    ...
    match(:*, "/api/v1/runs/:issue_identifier/context", ObservabilityApiController, :method_not_allowed)
